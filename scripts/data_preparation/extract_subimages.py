...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_folder", type=str, required=True, help="Path to save folder")
    ...
    parser.add_argument("--thresh_size", type=int, default=0, help="Threshold size")
    args = parser.parse_args()

    opt = {}
    opt['n_thread'] = args.n_threads
    opt['compression_level'] = args.compression_level
    opt['input_folder'] = args.input_folder
...
in powershell:
python extract_subimages.py `
--input_folder \\path\\to\\input_folder `
--save_folder \\path\\to\\save_folder `
--crop_size 128 `
--step 64 
"""